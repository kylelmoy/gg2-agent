...
const PostMessageW = user32.func('bool __stdcall PostMessageW(void*, uint32, void*, void*)');
...
const clickButton = (hwnd) => PostMessageW(hwnd, BM_CLICK, null, null);

module.exports = { windows, children, controlText, clickButton, classOf, titleOf, pidOf };
